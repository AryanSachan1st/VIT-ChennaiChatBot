...
class AuthService {
  constructor(mongoClient, chatHistoryService = null) {
  ...
  async deleteUser(userId) {
    try {
      ...
      // Cascade-delete chat history if service is available
      if (this.chatHistoryService) {
        await this.chatHistoryService.deleteHistory(userId);
      }

      console.log(`User ${userId} and their chat history deleted successfully`);
      return { success: true };
    } catch (error) {
